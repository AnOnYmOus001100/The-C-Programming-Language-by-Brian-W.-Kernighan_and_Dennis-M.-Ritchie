...
main( )
{
	...
	c = getchar(); // getchar reads next input character from a text stream, character is internally stored as a pattern
	while (c != EOF) { // loop runs till c not equals to  end of file
